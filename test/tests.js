...
describe("dotnotate object tests", function () {
    ...
    it("should return dot notated object regardless if one attribute has an array as a value", function () {
        const obj = dot.objNotateToString(test_data.array_value);
